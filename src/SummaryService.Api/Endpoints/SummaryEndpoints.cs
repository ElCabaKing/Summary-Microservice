...
public static class SummaryEndpoints
{
    public static void MapSummaryEndpoints(this WebApplication app)
    {
            ...
            CancellationToken ct) =>
        {
            ...
            {
                await WriteSseError(context, "Expected multipart form data", ct);
                return;
            }
            ...
            {
                await WriteSseError(context, "No document provided", ct);
                return;
            }
            ...
            await useCase.ExecuteAsync(stream, contentType, ct);
        })
        .WithName("SummarizeStream")
        .DisableAntiforgery();
    }

    private static async Task WriteSseError(HttpContext context, string message, CancellationToken ct)
    {
